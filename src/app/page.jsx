      ...
      <div>
          ...
          <div className=" lg:px-30  lg:h-180 flex flex-col lg:flex-row items-center justify-between">
            <div className="w-full lg:w-1/2 mb-40">
              ...
              <div>
                ...
                <p className="hidden lg:block mt-5  text-gray-400 lg:block text-xl lg:text-start ">
        ...
        <div>
          ...
          <div className='lg:flex'>
            ...
            <div className=' hidden lg:block  w-235'>
              ...
              <div className='  lg:flex  justify-items-center bg-white'>
                <div className=' w-full h-140  lg:flex justify-items-center '>
                  <div className='lg:flex ' >
                    ...
                    <img className='hidden lg:block' src="PlayStation.svg" alt="" />
                  </div>
            ...
            <div className='hidden lg:block ml-40'>
              <div className=' w-full h-auto   lg: bg-amber-600 bg-[#EDEDED]   '>
                <div className=' py-15 lg:flex'>
                  ...
                  <div className='lg:flex justify-end'>
                    <img className='hidden lg:block' src="MacPro.svg" alt="" />
                  </div>
                </div>
            ...
            <div className='lg:flex'>
              <div className='w-full h-140  lg:flex justify-items-center bg-[#EDEDED]  '>
                <div className='lg:flex'>
                  ...
                  <img className='hidden lg:block' src="max.svg" alt="" />
                  ...
                  <div className='w-full h-120  lg:flex justify-items-center bg-[#EDEDED]  '>
                    ...
                    <div className='text-center lg:mt-25'>
                      ...
                      <div className='mt-4  flex justify-center'>
                        ...
                        <p className='text-gray-400 text-xl  hidden lg:block px-20 ' >
          ...
          <div className=' '>
            <div className='  lg:flex justify-items-cente bg-white'>
              <div className=' block w-full h-140  lg:hidden  justify-items-center '>
                <div className='lg:flex'>
